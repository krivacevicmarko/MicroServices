...
import reservationservice.client.UserServiceConfiguration;

import java.io.IOException;
import java.util.Collections;

@Configuration
public class GymServiceConfiguration {

    @Bean
    public RestTemplate gymServiceRestTemplate(){
        RestTemplate restTemplate = new RestTemplate();
        restTemplate.setUriTemplateHandler(new DefaultUriBuilderFactory("http://localhost:8081/training"));
